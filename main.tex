...
\begin{frame}
    ...
    \begin{block}{Example}
    Cisco 6500 firmware 12.2(33)SXI2a (02-Sep-09 01:00)
    \begin{itemize}
    \item Serial OID: .1.3.6.1.2.1.47.1.1.1.1.11.1
    Cisco 6500 firmware 12.2(33)SXI3 (27-Oct-09 11:12)
    \begin{itemize}
    \item Serial OID: .1.3.6.1.2.1.47.1.1.1.1.11.2
    \end{block}
...
\begin{frame}
    \frametitle{SNMP: What we collect (1/3)}

    \begin{block}{Get switch information}
    \begin{itemize}
    \item Serial number
    \item Manufacturer
    \item Model
...
\begin{frame}
    \frametitle{SNMP: What we collect (2/3)}
...
\begin{frame}
    \frametitle{SNMP: What we collect (3/3)}

    \begin{block}{Get connections on each port}
    \begin{itemize}
    \item Mac addresses (one or many on some case)
    \item LLDP \& CDP neighbors (dialog \& information between switches)
    \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    ...
    \begin{block}{What more important information?}
    \begin{itemize}
