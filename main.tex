...
\begin{frame}
    ...
    \begin{block}{In test-suite we trust!}
        \begin{itemize}
            ...
            \small{$\geq$40 000 tests on the GLPI plugin and up to 2 000 on the agent}
...
\begin{frame}
    ...
    \item FusionInventory for GLPI 0.80 \\
        \small{featuring the configuration Wizard!}
    \item Debian package for fusioninventory-esx
    \end{itemize}
